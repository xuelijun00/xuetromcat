...
@Component
@PropertySource(value = "classpath:config/kylin.properties")   //读取properties文件
@ConfigurationProperties(prefix = "kylin")   //大致作用就是通过它可以把properties或者yml配置直接转成对象
public class KylinUtils {

    @Value(value = "${kylin.driver-class-name}")   //注入的是外部参数对应的property
